...
export default function ProductDetails() {
    return (
        <div className='p-7 space-y-5'>
            ...
            <h1 className='mt-20'>توضیحات تکمیلی درباره پروژه</h1>
            <p className='text-justify text-second-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis libero odit repellat nulla repellendus accusamus dolores doloribus incidunt recusandae, eius soluta, autem perspiciatis ratione sunt? Quos iste nemo eius libero.
