  ...
  return (
    <div className="bg-white dark:bg-dark">
      <div className="p-7 space-y-5 container mx-auto">
          ...
          <div className="space-y-5">
            <div className="mt-12 flex items-center justify-between md:mt-0">
              <div className="flex items-center gap-4">
                ...
                <h1 className="font-IranYekanBold dark:text-white text-black">سهیل شکریان</h1>
              </div>
        ...
        />
        <h1 className="text-center mt-10 dark:text-white text-black">سهیل شکریان</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-2 *:border-1 *:border-zinc-200">
        ...
        <ul className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-2 *:border-1 *:border-zinc-200">
          <li className="space-y-3 shadow-xl shadow-zinc-200/50 dark:shadow-none dark:bg-white/3 p-3 rounded-lg">
            <img
              src="/images/article1.png"
              alt=""
